...
#ifdef USE_MEMCACHE
#define MEMCACHED_USER_TOKEN  0x1
#define MEMCACHED_GROUP_TOKEN 0x2
#define DB_USER_TOKEN         0x4
#define DB_GROUP_TOKEN        0x8
#define MEMCACHED_BOTH_TOKENS (MEMCACHED_USER_TOKEN | MEMCACHED_GROUP_TOKEN)
  unsigned short is_memcached;
#endif
} *ds_term_t;
